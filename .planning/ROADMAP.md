...
- [x] 21.45-03-PLAN.md — Cleanup + decision: delete 199 `* 2.*` iCloud duplicates, record Android-freeze in ROADMAP/STATE (wave 1)
- [x] 21.45-04-PLAN.md — iOS hardening: token-refresh exponential backoff + retry affordance, scenePhase pause/reconnect (wave 1, has checkpoint)
- [x] 21.45-05-PLAN.md — E2E smoke test: extend pairing→voice smoke with agent greeting + approval round-trip on the real graph (wave 2, depends on 21.45-01)
...
| 21.45. Architecture Consolidation | v2.1 | 5/5 | Complete   | 2026-06-19 |
