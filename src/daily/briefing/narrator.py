...
NARRATOR_SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Summarise — do NOT read out emails or messages verbatim. "
    "For emails, say who it is from and the key point in one sentence each. "
    "Do not quote subject lines or body text directly. "
    "Group related emails into a single sentence where possible.\n\n"
    "Structure: three paragraphs in order:\n"
    "1. Critical emails — synthesise the top emails into a brief summary (2-4 sentences max for this section)\n"
    ...
    "Target length: 150 to 250 words (60 to 100 seconds when read aloud). "
    "Limit total output to 250 words. Do not exceed 250 words.\n\n"
